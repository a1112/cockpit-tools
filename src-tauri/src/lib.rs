...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::claude::import_claude_from_local,
            commands::claude::add_claude_account_with_token,
            commands::claude::export_claude_accounts,
            commands::claude::refresh_claude_token,
            commands::claude::refresh_all_claude_tokens,
            commands::claude::inject_claude_account,
